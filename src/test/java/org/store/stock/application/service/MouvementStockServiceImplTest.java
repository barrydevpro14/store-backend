...
class MouvementStockServiceImplTest {
    ...
    private UserPrincipal proprietaire() {
        return new UserPrincipal(UUID.randomUUID(), UUID.randomUUID(), entrepriseId, null, "owner", "PROPRIETAIRE", List.of("STOCK_READ"));
    }
    ...
    void filter_should_convert_dates_to_startOfDay_and_endOfDay() {
        MouvementStockFilter filter = new MouvementStockFilter(magasinId, null, null, null, "2026-05-01", "2026-05-14", 0, 10);
    ...
    void filter_should_return_null_dateTime_when_blank_or_null_dates() {
        MouvementStockFilter filterNulls = new MouvementStockFilter(magasinId, null, null, null, null, null, 0, 10);
        MouvementStockFilter filterBlanks = new MouvementStockFilter(magasinId, null, null, null, "", "  ", 0, 10);
