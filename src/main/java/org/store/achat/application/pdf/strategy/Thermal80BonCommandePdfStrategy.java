...
@Service
public class Thermal80BonCommandePdfStrategy implements BonCommandePdfStrategy {

    private final ThermalBonCommandePdfRenderer renderer;

    public Thermal80BonCommandePdfStrategy(ThermalBonCommandePdfRenderer renderer) {
