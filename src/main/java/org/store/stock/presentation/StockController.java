...
public class StockController {
    ...
    public ResponseEntity<Page<StockResponse>> list(@RequestParam(required = false) UUID magasinId,
                                                    @RequestParam(required = false) UUID productId,
                                                    Pageable pageable) {
        return ResponseEntity.ok(stockService.findAllByCurrentEntreprise(magasinId, productId, pageable));
    }
