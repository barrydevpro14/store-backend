...
public interface CommandeVenteRepository extends BaseRepository<CommandeVente>, JpaSpecificationExecutor<CommandeVente> {

    @Override
    @EntityGraph(attributePaths = {"facture", "client"})
    Page<CommandeVente> findAll(Specification<CommandeVente> spec, Pageable pageable);
